...
- [19:27 — Multi-section measured wing planforms](2026-09-09-1927-multi-section-wing-planform.md): replaced the Dolphin's geometry-only equivalent trapezoid with one measured section source shared by OpenVSP, OAS, Studio, and QA, raising top/front IoU to 0.969/0.897 and re-closing at 12/12 gates.
