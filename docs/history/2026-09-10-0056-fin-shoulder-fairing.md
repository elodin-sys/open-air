...
- Commits: recorded in the follow-up history commit
...
- Replaced the broad slab verdict with local schema-section containment, a
  10 mm or 0.2%-length proximity floor, and a 95% fairing-base support gate.

## Outcome

The Dolphin uses an eight-station shoulder and 33 mm buried root continuation.
Both reopened-VSP3 and STL checks pass: root eccentricity is 0.546, nearest
surface distance is 2.24/1.67 mm, and fairing-base support is 95.4%.
Reference geometry remains green (body-union p95 12.50 mm; top/side/front IoU
...
The slight whole-aircraft p95 movement from 13.24 to 13.69 mm is the disclosed
