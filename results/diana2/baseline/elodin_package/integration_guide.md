# diana2-baseline — Elodin integration guide
...
1. Require `schema_version == "1.0"` and the identity your
   scenario expects (`concept` = `diana2`, `phase` = `baseline`).
...
tail_incidence held at -2.46893 deg:

```text
CL = -0.066502 + 6.14048*alpha
Cm = 0.145049 - 2.21812*alpha   (about the CG)
CD = 0.0314037 + 0.013236*CL^2
```
...
3.74664 deg, throttle 0.18); re-solve equilibrium for any other condition
