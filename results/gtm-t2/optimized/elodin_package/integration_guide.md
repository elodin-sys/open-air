# gtm-t2-optimized — Elodin integration guide
...
1. Require `schema_version == "1.0"` and the identity your
   scenario expects (`concept` = `gtm-t2`, `phase` = `optimized`).
...
6.56316 deg, throttle 0.192673); re-solve equilibrium for any other condition
