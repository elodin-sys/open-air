# ceras-csr01-baseline — Elodin integration guide
...
1. Require `schema_version == "1.0"` and the identity your
   scenario expects (`concept` = `ceras-csr01`, `phase` = `baseline`).
...
4.56278 deg, throttle 0.869465); re-solve equilibrium for any other condition
