# atomrc-dolphin-v1-1-baseline — Elodin integration guide
...
1. Require `schema_version == "1.0"` and the identity your
   scenario expects (`concept` = `atomrc-dolphin-v1-1`, `phase` = `baseline`).
...
elevon held at 9.63843 deg (trailing edge up positive; solver trim, not a
measured neutral):

```text
CL = -0.128071 + 4.01823*alpha
Cm = 0.0170096 - 0.173517*alpha   (about the CG)
CD = 0.0343832 + 0.0707846*CL^2
```
...
5.61836 deg, throttle 0.3); re-solve equilibrium for any other condition
